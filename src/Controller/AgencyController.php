...
{
    #[Route('/registration', name: 'registeragency', methods: ['GET', 'POST'])]
    public function register(Request $request, AgencyRepository $agencyRepository): Response
    {
        $agency = new Agency();
        ...
        return $this->renderForm('agency/register.html.twig', [
