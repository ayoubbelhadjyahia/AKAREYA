...
class UserController extends AbstractController
{
    ...
    #[Route('/{id}/editcompte', name: 'app_user_edit_compte', methods: ['GET', 'POST'])]
    public function editCompte(Request $request, User $user, UserRepository $userRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('show_Compte', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/showcompte', name: 'show_Compte')]
    ...
    #[Route('/registration', name: 'registeruser', methods: ['GET', 'POST'])]
